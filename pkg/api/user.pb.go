...
func (m *Change) GetData() isChange_Data {
	if m != nil {
		return m.Data
	}
	return nil
...
func (x *Change) GetName() string {
	if x, ok := x.GetData().(*Change_Name); ok {
		return x.Name
	}
	return ""
}

func (x *Change) GetEmail() string {
	if x, ok := x.GetData().(*Change_Email); ok {
		return x.Email
	}
	return ""
}

func (x *Change) GetPassword() string {
	if x, ok := x.GetData().(*Change_Password); ok {
		return x.Password
	}
	return ""
}
...
type Change_Name struct {
	Name string `protobuf:"bytes,2,opt,name=name,proto3,oneof"`
}

type Change_Email struct {
...
func (*Change_Name) isChange_Data() {}

func (*Change_Email) isChange_Data() {}

func (*Change_Password) isChange_Data() {}
...
func (x *GetAllUsersReply) GetUserList() []*User {
	if x != nil {
		return x.UserList
	}
	return nil
...
var file_api_user_proto_rawDesc = []byte{
	...
	0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x4c, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x12, 0x0a,
	...
	0x6f, 0x72, 0x64, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x14, 0x0a, 0x02,
	0x49, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02,
	0x69, 0x64, 0x22, 0x5c, 0x0a, 0x06, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x04,
	...
	0x09, 0x48, 0x00, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1c, 0x0a, 0x08, 0x70, 0x61,
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x08,
	0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61,
	...
	0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x2b, 0x0a, 0x0f, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x18,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x28, 0x0a, 0x0c, 0x47, 0x65,
	0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x22, 0x32, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73,
	...
	0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x2b, 0x0a, 0x0f, 0x55, 0x70, 0x64, 0x61,
	...
	0x6c, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x39, 0x0a,
	0x10, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x12, 0x25, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x08,
	0x75, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xbd, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65,
	0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x12, 0x3c, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61,
	...
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x33, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	...
	0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0a, 0x55,
	...
	0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0a, 0x44, 0x65, 0x6c,
	...
	0x14, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x3f, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x41, 0x6c,
	...
	0x15, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72,
	0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x6c,
	0x61, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x76, 0x75, 0x6e, 0x64, 0x35, 0x2f, 0x75, 0x73, 0x65,
	0x72, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69,
...
var file_api_user_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_api_user_proto_goTypes = []interface{}{
	(*User)(nil),               // 0: api.User
	(*Empty)(nil),              // 1: api.Empty
	(*Id)(nil),                 // 2: api.Id
	(*Change)(nil),             // 3: api.Change
	(*CreateUserRequest)(nil),  // 4: api.CreateUserRequest
	(*CreateUserReply)(nil),    // 5: api.CreateUserReply
	(*GetUserRequest)(nil),     // 6: api.GetUserRequest
	(*GetUserReply)(nil),       // 7: api.GetUserReply
	(*UpdateUserRequest)(nil),  // 8: api.UpdateUserRequest
	(*UpdateUserReply)(nil),    // 9: api.UpdateUserReply
	(*DeleteUserRequest)(nil),  // 10: api.DeleteUserRequest
	(*DeleteUserReply)(nil),    // 11: api.DeleteUserReply
	(*GetAllUsersRequest)(nil), // 12: api.GetAllUsersRequest
	(*GetAllUsersReply)(nil),   // 13: api.GetAllUsersReply
}
var file_api_user_proto_depIdxs = []int32{
	0,  // 0: api.UpdateUserRequest.user:type_name -> api.User
	0,  // 1: api.GetAllUsersReply.userList:type_name -> api.User
	4,  // 2: api.UserManager.CreateUser:input_type -> api.CreateUserRequest
	6,  // 3: api.UserManager.GetUser:input_type -> api.GetUserRequest
	8,  // 4: api.UserManager.UpdateUser:input_type -> api.UpdateUserRequest
	10, // 5: api.UserManager.DeleteUser:input_type -> api.DeleteUserRequest
	12, // 6: api.UserManager.GetAllUsers:input_type -> api.GetAllUsersRequest
	5,  // 7: api.UserManager.CreateUser:output_type -> api.CreateUserReply
	7,  // 8: api.UserManager.GetUser:output_type -> api.GetUserReply
	9,  // 9: api.UserManager.UpdateUser:output_type -> api.UpdateUserReply
	11, // 10: api.UserManager.DeleteUser:output_type -> api.DeleteUserReply
	13, // 11: api.UserManager.GetAllUsers:output_type -> api.GetAllUsersReply
